...
setup(
    ...
    install_requires=['numpy', 'astropy', 'astroquery', 'matplotlib', 'scipy', 'pyds9', 'colormath', 'parse'],
    dependency_links=['git+https://github.com/ericmandel/pyds9.git@v1.8.1#egg=pyds9'],
